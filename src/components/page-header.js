        ...
        <div className={"flex items-center sticky top-0 left-0 right-0 md:px-8 px-6 py-4 bg-white z-20"}>
            {props.location.pathname === '/' ? (
                ...
                <div className={"flex items-center"}>
                    <Link className={"md:mr-4 mr-2 md:w-10 w-6 md:h-10 p-1 h-6 flex items-center justify-center rounded-full hover:text-gray-900 border-2 border-transparent hover:border-black"} to="/">
